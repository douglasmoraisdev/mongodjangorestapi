...
def add_servant_list(request):
	...
	template = loader.get_template('user_modals/servant_item_list_add.html')
...
def add_servant_list_presence(request):
	...
	template = loader.get_template('user_modals/servant_item_list_presence_add.html')
...
def add_member_list(request):
	...
	template = loader.get_template('user_modals/member_item_list_add.html')
...
def add_member_list_presence(request):
	...
	template = loader.get_template('user_modals/member_item_list_presence_add.html')

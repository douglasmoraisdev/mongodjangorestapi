...
window.optionsLine = {  
        ...
        animationSteps: 100,// Number - Number of animation steps        
        ...
        tooltipXPadding: 16,// Number - pixel widtho f padding around tooltip text      
...
window.onload = function(){
    ...
    window.trendingLineChart = new Chart(trendingLineChart).Line(window.dataLine1, window.optionsLine);
...
function updateGroupChart(){
    ...
    if ($('#group-chart').prop('checked')){
        ...
        window.trendingLineChart.update();
    }else{
        window.trendingLineChart.destroy();        
        var trendingLineChart = document.getElementById("trending-line-chart").getContext("2d");        
        window.trendingLineChart = new Chart(trendingLineChart).Line(window.dataLine1, window.optionsLine);

...
class ViewModelTest_Add(test_addons.MongoTestCase):
	...
	def test_add_user(self):
		...
		response = client.post('/core/novouser', {'nome_usuario':'TioJoao'})
	...
	def test_add_role(self):
		...
		response = client.post('/core/novorole', {'nome_funcao':'Lider'})
	...
	def test_add_grouptype(self):
		...
		response = client.post('/core/novogrouptype', {'codigo_tipo_grupo':'celula', 'nome_tipo_grupo':'Célula'})
	...
	def test_add_newevent(self):
		...
		response = client.post('/core/newevent', 
									{

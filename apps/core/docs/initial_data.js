...
db.groups_types.insert({code:"group", name:"Célula"});
...
/* Group roles */
var visitor = {code:"visitor", name:"Visitante", app_scope:["group", "group_metting"]};
db.roles.save(visitor);
var group_member = {code:"group_member", name:"Membro em Célula", app_scope:["group", "group_metting"]};
db.roles.save(group_member);
var host = {code:"host", name:"Anfitrião", app_scope:["group", "group_metting"]};
db.roles.save(host);
var leader = {code:"leader", name:"Lider", app_scope:["group", "group_metting"]};
...
db.permissions.insert({target_app:"groups", perms: "r", role: group_member._id});

db.permissions.insert({target_app:"events", perms: "rwc+", role: leader._id});
db.permissions.insert({target_app:"events", perms: "r", role: group_member._id});
